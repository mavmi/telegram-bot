...
@Component
public class EditGroupFertilizeServiceModule implements ServiceModule<WaterStuffServiceRq> {
    ...
    private void getCurrentMonthCalendar(WaterStuffServiceRq request) {
        commonServiceModule.getCacheComponent().getCacheBucket().getDataCache(WaterDataCache.class).getMenuContainer().add(WaterStuffServiceMenu.EDIT_FERTILIZE);
