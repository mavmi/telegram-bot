...
public class EditGroupWaterServiceModule implements ServiceModule<WaterStuffServiceRs, WaterStuffServiceRq> {
    ...
    private WaterStuffServiceRs getCurrentMonthCalendar(WaterStuffServiceRq request) {
        commonServiceModule.getCacheComponent().getCacheBucket().getDataCache(WaterStuffServiceDataCache.class).getMenuContainer().add(WaterStuffServiceMenu.EDIT_WATER);
