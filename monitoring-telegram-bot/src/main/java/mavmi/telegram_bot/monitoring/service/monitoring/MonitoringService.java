...
import mavmi.telegram_bot.monitoring.service.monitoring.serviceModule.MainMenuServiceModule;
...
import mavmi.telegram_bot.monitoring.service.monitoring.serviceModule.botAccess.BotAccessServiceModule;
import mavmi.telegram_bot.monitoring.service.monitoring.serviceModule.common.CommonServiceModule;
import mavmi.telegram_bot.monitoring.service.monitoring.serviceModule.pms.PmsNewValueServiceModule;
import mavmi.telegram_bot.monitoring.service.monitoring.serviceModule.pms.PmsServiceModule;
import mavmi.telegram_bot.monitoring.service.monitoring.serviceModule.privileges.PrivilegesAddServiceModule;
import mavmi.telegram_bot.monitoring.service.monitoring.serviceModule.privileges.PrivilegesDeleteServiceModule;
import mavmi.telegram_bot.monitoring.service.monitoring.serviceModule.privileges.PrivilegesInitServiceModule;
import mavmi.telegram_bot.monitoring.service.monitoring.serviceModule.privileges.PrivilegesServiceModule;
...
public class MonitoringService implements Service<MonitoringServiceRq> {
    ...
    @Autowired
    public void setup(AppsServiceModule appsServiceModule,
